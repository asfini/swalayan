  ...
  <form action="proses/proses_barang.php?aksi=simpan" method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <div class="card-body">
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" name="id_barang" value="<?php echo $idbarang ?>" readonly class="form-control">
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <img id="blah" src="gambar/display.png" alt="your image" width="200px" height="200px" />
        </div>
      </div>
        ...
        while ($data = mysqli_fetch_array($query)) {
          ...
          <tr>
            ...
            <td>
              ...
              <a href="proses/proses_barang.php?aksi=delete&id_barang=<?php echo $data['id_barang'] ?>"
