                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="id_transaksi" value="<?php echo $idtransaksi ?>" readonly
                                    class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="tanggal"
                                    ...
                                    value="<?php echo $Now->format('Y-m-d H:i:s'); ?>" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
        ...
        while ($data = mysqli_fetch_array($query)) {
          ?>
                <tr>
                    ...
                    <td>
                        <a href="proses/transaksi.php?aksi=delete&id_transaksi=<?php echo $data['id_transaksi'] ?>"
