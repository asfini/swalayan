...
switch($aksi){
  ...
  case 'update':
    ...
    $password = $_POST['password'];
    $no_hp = $_POST['no_hp'];
    $query = mysqli_query($koneksi, "UPDATE user SET nama_user ='$nama_user', jenis_kelamin = '$jenis_kelamin',username ='$username', password = '$password',no_hp = '$no_hp' WHERE id_user = '$id_user' ");
    header("location:../admin.php?page=user");
    break;
  case 'delete':
